...
const sidebarVariants: Variants = {
    ...
    visible: { x: '0%' as const, transition: { type: 'spring', stiffness: 300, damping: 30 } },
    exit: { x: '100%' as const, transition: { type: 'spring', stiffness: 300, damping: 30 } }
};
    ...
    return (
        <main className=" h-[600px] overflow-hidden">
            ...
            <motion.div
                ...
                animate="visible"
                exit="exit"
                className={`${isOpen ? " fixed p-12 inset-y-0 right-0 w-full md:w-3/4 bg-[#FFFFFF] z-[2] overflow-hidden shadow-lg" : "aegov-tab tab-pills h-full"}`}>
               ...
               ${isOpen ? " flex mt-8 right-3 w-11/12 h-[550px] z-[3] " : "hidden"}`}
